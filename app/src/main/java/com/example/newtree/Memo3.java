...
public class Memo3 extends AppCompatActivity {
    ...
    private EditText editText_TextArea3;
    private String fileName = "MyMemo3.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_TextArea3 = findViewById(R.id.editText3);
    ...
    View.OnClickListener btnLoadListener = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                editText_TextArea3.setText(new String(data));
    ...
    View.OnClickListener btnSaveListener = new View.OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                outputStream.write(editText_TextArea3.getText().toString().getBytes());
                outputStream.close();
