...
public class Memo4 extends AppCompatActivity {
    ...
    private EditText editText_TextArea4;
    private String fileName = "MyMemo4.txt";
    private long backPressTime = 0;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_memo4);


        btn_Save = findViewById(R.id.button_save);
        btn_Load = findViewById(R.id.button_load);
        btn_Delete = findViewById(R.id.button_delete);
        editText_TextArea4 = findViewById(R.id.editText3);
    ...
    View.OnClickListener btnLoadListener = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                editText_TextArea4.setText(new String(data));
    ...
    View.OnClickListener btnSaveListener = new View.OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                outputStream.write(editText_TextArea4.getText().toString().getBytes());
                outputStream.close();
