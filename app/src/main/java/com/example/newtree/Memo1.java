...
public class Memo1 extends AppCompatActivity {
    ...
    private EditText editText_TextArea1;
    private String fileName = "MyMemo1.txt";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editText_TextArea1 = findViewById(R.id.editText3);
    ...
    View.OnClickListener btnLoadListener = new View.OnClickListener()
    {
        ...
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                editText_TextArea1.setText(new String(data));
    ...
    View.OnClickListener btnSaveListener = new View.OnClickListener()
    {
        public void onClick(View v)
        {
            ...
            try
            {
                ...
                outputStream.write(editText_TextArea1.getText().toString().getBytes());
                outputStream.close();
